    ...
    return (
        <div className="mt-32 mx-3">
            ...
            <div className="my-3">
                ...
                <p className="bg-secondary text-quaternary text-lg mt-0 px-5 py-3 rounded-b-lg rounded-tr-lg md:text-xl">I’m an ex-teacher, web developer interested in being a full stack MERN developer for educational organizations and institutions. I'm interested in building browser games that teachers can customize for their classrooms and enhance student engagement. If you have any questions or want to get in touch, contact me via one of the methods below.</p>
            </div>
        </div>
    )
}